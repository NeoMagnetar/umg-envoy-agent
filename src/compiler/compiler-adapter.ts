...
function resolveSleeve(metaUrl: string, sleeveId: string): { root: string; sleeve: PublicSleeve } {
...
export function compileSleeveById(sleeveId: string, config?: PluginConfig, metaUrl = import.meta.url): CompileSleeveResult {
