...
assert("all 20 seeded tool ids are represented in the seed", ENVOY_TOOL_CAPABILITY_REGISTRY_SEED.length === 20 && expectedToolIds.every((toolId) => Boolean(resolveEnvoySeededToolCapability(toolId))));
