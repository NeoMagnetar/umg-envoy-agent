import {
  ...
  isToolCapabilityKnown,
  canToolRunDirectly,
  requiresApprovalForCapability,
  requiresPreviewForCapability,
  requiresDryRunForCapability,
  requiresBackupForCapability,
  type ToolCapabilityRegistryEntry,
  type ToolResult,
...
const knownEntries: ToolCapabilityRegistryEntry[] = [
  {
