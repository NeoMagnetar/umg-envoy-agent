...
function event(payload: Partial<LangChainBridgePayload>, event_type: string, message: string, data: Record<string, unknown> = {}): TraceEvent {
  return {
    event_type,
...
export function checkLangChainProviderReadiness(payload: LangChainBridgePayload): { readiness: ProviderReadinessResult; traceEvents: TraceEvent[] } {
