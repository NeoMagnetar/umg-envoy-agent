...
export function compileRuntimeSpecDryRun(input: RuntimeSpecCompileInput): RuntimeSpecV0 {
  ...
  if (selection.candidates.sleeve && selection.active_sleeve) selection_events.push(event("SLEEVE_CANDIDATE_SELECTED", "Selected strongest sleeve candidate.", selection.candidates.sleeve));
