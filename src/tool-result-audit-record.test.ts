import {
  assertToolResultNotCompilerTrace,
  ...
  linkToolResultToActionGate,
  validateToolResultAuditRecord,
  type ApprovalRecord,
  type ToolCapability,
  type ToolResult,
...
const readiness = evaluateApprovalGatedWriteReadiness(
  actionGate,
  capability,
  { approvalRecord },
  createApprovalGatedWritePolicy(),
...
const traceLikeToolResult: ToolResult = {
  ...notExecutedDraft,
  auditLink: {
