import { classifyRiskClassPolicy, createProposedActionGate, canProceedDirectly, requiresApproval, requiresPreview, requiresRollback } from "./action-gate-types.js";
let passed = 0;
let failed = 0;
