...
assert("allowed static tool ids are exactly the six approved tools", JSON.stringify(LOW_RISK_DIRECT_TOOL_IDS) === JSON.stringify([
    "umg_envoy_status",
...
assert("umg_envoy_load_sleeve is not in LOW_RISK_DIRECT_TOOL_IDS", LOW_RISK_DIRECT_TOOL_IDS.includes("umg_envoy_load_sleeve") === false);
...
assert("umg_envoy_explain_sleeve is not in LOW_RISK_DIRECT_TOOL_IDS", LOW_RISK_DIRECT_TOOL_IDS.includes("umg_envoy_explain_sleeve") === false);
...
assert("umg_envoy_cognitive_registry_query is not in LOW_RISK_DIRECT_TOOL_IDS", LOW_RISK_DIRECT_TOOL_IDS.includes("umg_envoy_cognitive_registry_query") === false);
...
assert("umg_envoy_validate_composed_sleeve_dry_run is not in LOW_RISK_DIRECT_TOOL_IDS", LOW_RISK_DIRECT_TOOL_IDS.includes("umg_envoy_validate_composed_sleeve_dry_run") === false);
...
const failureResult = executeLowRiskDirectTool({ toolId: "umg_envoy_render_path", input: { source: null } });
