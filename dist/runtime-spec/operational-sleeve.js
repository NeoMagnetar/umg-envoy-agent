...
export function listOperationalSleeves() {
...
export function inspectOperationalSleeve(input) {
    ...
    if (!sleeve)
        return notFoundResult(input.sleeve_id);
...
export function demoOperationalSleeve(input) {
    ...
    if (!sleeve)
        return notFoundResult(input.sleeve_id);
    if (!sleeve.demo_ready)
        return notDemoReadyResult(sleeve);
...
function demoDashboardForSleeve(sleeve, mode) {
...
function toolPlanFromSleeve(sleeve) {
    return {
...
function notDemoReadyResult(sleeve) {
    return {
