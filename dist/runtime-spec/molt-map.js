...
function field(value, source, artifact_ids, confidence, notes) {
    return { value, source, artifact_ids, confidence, notes };
}
export function buildRuntimeMOLTMap(spec) {
    ...
    const Trigger = field(spec.input.user_task || "n/a", spec.input.user_task ? "runtime_input" : "n/a", [], spec.input.user_task ? "high" : "n/a");
