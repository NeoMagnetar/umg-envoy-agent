...
export type ApprovalContractStatus = "not_required" | "required" | "pending" | "approved_future_only" | "denied" | "blocked" | "expired" | "invalid";
export type CheckpointContractStatus = "not_required" | "required" | "draft" | "ready_to_write_future_only" | "written_future_only" | "invalid" | "expired";
export type ResumeContractStatus = "not_applicable" | "requires_checkpoint" | "resume_ready_future_only" | "invalid" | "expired";
...
export interface ApprovalCheckpointPreflightCheckV0 {
    code: "runtime_spec_match" | "tool_plan_match" | "selected_context_match" | "approval_request_match" | "approval_valid" | "approval_scope_match" | "blocked_tools_absent" | "unknown_tools_absent" | "policy_version_match" | "checkpoint_exists" | "resume_reference_valid" | "execution_mode_allowed" | "support_doc_source_rejected" | "user_visible_summary_match";
    required: true;
...
export interface PreflightValidationCheckV0 {
    check: "runtime_spec_match" | "tool_plan_match" | "selected_context_match" | "approval_request_match" | "approval_scope_match" | "blocked_tools_absent" | "unknown_tools_absent" | "policy_version_match" | "checkpoint_required" | "resume_reference_valid" | "support_doc_tool_source_absent" | "execution_mode_not_blocked";
    passed: boolean;
    reason: string;
}
