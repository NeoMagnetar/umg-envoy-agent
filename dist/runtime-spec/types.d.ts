export type RuntimeSpecStatus = "draft" | "compiled" | "assembled_runtime" | "blocked" | "invalid";
export type RuntimeKind = "sleeve_runtime" | "neostack_runtime" | "assembled_runtime";
...
export interface RuntimeSpecSelectionEvent {
    event: "RUNTIMESPEC_CREATED" | "SLEEVE_CANDIDATE_SELECTED" | "NEOSTACK_SELECTED" | "NEOBLOCK_SELECTED" | "MOLT_BLOCK_SELECTED" | "SUPPORT_ARTIFACT_ATTACHED" | "TOOL_BINDING_REQUESTED" | "APPROVAL_REQUIRED" | "GOVERNANCE_HANDOFF_CREATED" | "SELECTION_WARNING";
    artifact_id?: string;
    reason: string;
    provenance?: {
        source_kind: string;
