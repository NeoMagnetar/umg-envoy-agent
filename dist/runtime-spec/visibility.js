export function buildRuntimeVisibilityHeader(spec, mode = "developer") {
    return {
...
export function renderRuntimeVisibilityHeader(header) {
    const lines = [
...
function toolBindingSummaryText(header) {
    const parts = [];
...
function governanceSummaryText(header) {
    const parts = [
