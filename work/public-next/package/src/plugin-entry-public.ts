...
function realSleeveInspect(sleeveId: string, libraryRoot?: string, shallowLoadTargetRef?: string) {
...
function currentSleeveStatus(sleeveId?: string, libraryRoot?: string) {
...
function neostackInspect(sleeveId?: string, neostackId?: string, includeNeoBlocks?: boolean, libraryRoot?: string) {
...
function moltblockInspect(moltBlockId?: string, sleeveId?: string, neoblockId?: string, libraryRoot?: string) {
  return inspectMoltBlock({ moltBlockId, sleeveId, neoblockId, libraryRoot });
}

function runtimeIrPath(sleeveId?: string, includeDormant?: boolean, includeExcludedLanes?: boolean, libraryRoot?: string) {
  return getRuntimeIrPath({ sleeveId, includeDormant, includeExcludedLanes, libraryRoot });
}

function runtimeIrMatrixFull(sleeveId?: string, includeDormant?: boolean, includeExcludedLanes?: boolean, includeEdges?: boolean, includeNlProjection?: boolean, libraryRoot?: string) {
