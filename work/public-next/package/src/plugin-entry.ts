  ...
  api.registerCli(({ program }: { program: any }) => {
    ...
    root.command("block-library-status")
      ...
      .action(async (opts: { root?: string }) => {
        console.log(JSON.stringify(getBlockLibraryStatus("0.3.0-alpha.7", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot()), null, 2));
      });

    root.command("block-library-manifest-index")
      .option("--root <path>")
      .action(async (opts: { root?: string }) => {
        console.log(JSON.stringify(getBlockLibraryManifestIndex("0.3.0-alpha.7", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot()), null, 2));
      });
    ...
    root.command("sleeve-select")
      ...
      .action(async (opts: { sleeveId?: string; selectionMode?: string; persistSelection?: boolean; runtimeSessionId?: string; root?: string }) => {
        console.log(JSON.stringify(selectRuntimeSleeve("0.3.0-alpha.7", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot(), { sleeveId: opts.sleeveId, selectionMode: opts.selectionMode as any, persistSelection: Boolean(opts.persistSelection), runtimeSessionId: opts.runtimeSessionId }), null, 2));
      });
    ...
    root.command("runtime-compile")
      ...
      .action(async (opts: { sleeveId?: string; runtimeSessionId?: string; resolveDepth?: string; strictness?: string; compileMode?: string; root?: string }) => {
        console.log(JSON.stringify(compileRuntimeSleeve("0.3.0-alpha.7", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot(), { sleeveId: opts.sleeveId, runtimeSessionId: opts.runtimeSessionId, resolveDepth: opts.resolveDepth as any, strictness: opts.strictness as any, compileMode: opts.compileMode ?? 'dry_run' }), null, 2));
      });
