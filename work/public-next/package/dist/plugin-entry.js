...
import { classifyRuntimeToolRequests, compileRuntimeSleeve, createRuntimeApprovalCheckpoints, createRuntimeExecutionGatePlan, defaultBlockLibraryRoot, executeApprovedAllowlistedRuntimeAction, getBlockLibraryActiveStackProjection, getBlockLibraryManifestEntryLookup, getBlockLibraryManifestIndex, getBlockLibraryMoltMapCompose, getBlockLibraryMoltMapFragment, getBlockLibraryMoltblockVisibleExtract, getBlockLibraryNeoblockInspect, getBlockLibraryResponseEnvelopeFragment, getBlockLibrarySleeveGraphDrilldown, getBlockLibrarySleeveGraphIndex, getBlockLibraryStatus, getBlockLibraryTargetShallowLoadGate, getBlockLibraryTargetShallowLoadSingle, getBlockLibraryTargetShallowSummaryNormalize, inspectRuntimeActiveSleeveIrMatrixEnvelope, previewRuntimeSleeve, resumeRuntimeApprovalCheckpoint, resolveRuntimeSleeveGraph, runBoundedReadOnlyOrchestration, runRuntimeExecutionChainE2EApprovedReadOnly, selectRuntimeSleeve } from "./block-library-resolver.js";
...
function registerCliBridge(api, config) {
    api.registerCli(({ program }) => {
        ...
        root.command("sleeve-select")
            ...
            .option("--root <path>")
            .action(async (opts) => {
            console.log(JSON.stringify(selectRuntimeSleeve("0.3.0-alpha.8", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot(), { sleeveId: opts.sleeveId, selectionMode: opts.selectionMode, persistSelection: Boolean(opts.persistSelection), runtimeSessionId: opts.runtimeSessionId }), null, 2));
        });
        ...
        root.command("runtime-compile")
            ...
            .option("--root <path>")
            .action(async (opts) => {
            console.log(JSON.stringify(compileRuntimeSleeve("0.3.0-alpha.8", "dist/plugin-entry.js", opts.root ?? defaultBlockLibraryRoot(), { sleeveId: opts.sleeveId, runtimeSessionId: opts.runtimeSessionId, resolveDepth: opts.resolveDepth, strictness: opts.strictness, compileMode: opts.compileMode ?? 'dry_run' }), null, 2));
        });
...
const entry = {
    ...
    register(api, config) {
        ...
        api.registerTool({ name: "umg_envoy_block_library_status", description: "Report read-only real UMG Block Library resolver status for the official alpha6 runtime.", parameters: Type.Object({ root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryStatus("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot()), null, 2) }] }; } }, { optional: true });
        api.registerTool({ name: "umg_envoy_block_library_manifest_index", description: "Inspect approved block-library manifest/index files without loading target payloads.", parameters: Type.Object({ root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryManifestIndex("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot()), null, 2) }] }; } }, { optional: true });
        api.registerTool({ name: "umg_envoy_block_library_manifest_entry_lookup", description: "Look up a single manifest/index entry without loading the target payload.", parameters: Type.Object({ entryId: Type.Optional(Type.String()), sourcePath: Type.Optional(Type.String()), manifestKind: Type.Optional(Type.String()), includeManifestSummary: Type.Optional(Type.Boolean()), includeRaw: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryManifestEntryLookup("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { entryId: input.entryId, sourcePath: input.sourcePath, manifestKind: input.manifestKind ?? 'all', includeManifestSummary: input.includeManifestSummary !== false, includeRaw: Boolean(input.includeRaw) }), null, 2) }] }; } }, { optional: true });
        api.registerTool({ name: "umg_envoy_block_library_target_shallow_load_gate", description: "Determine whether a manifest-indexed target is eligible for future shallow loading without loading the payload.", parameters: Type.Object({ entryId: Type.Optional(Type.String()), sourcePath: Type.Optional(Type.String()), manifestKind: Type.Optional(Type.String()), intendedLoadMode: Type.Optional(Type.String()), includeEntrySummary: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryTargetShallowLoadGate("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { entryId: input.entryId, sourcePath: input.sourcePath, manifestKind: input.manifestKind ?? 'all', intendedLoadMode: input.intendedLoadMode ?? 'shallow', includeEntrySummary: input.includeEntrySummary !== false }), null, 2) }] }; } }, { optional: true });
        ...
        api.registerTool({ name: "umg_envoy_block_library_molt_map_compose", description: "Compose a full seven-field MOLT Map from an explicit list of NeoBlock ids using the fragment path.", parameters: Type.Object({ neoblockIds: Type.Array(Type.String()), manifestKind: Type.Optional(Type.String()), summaryProfile: Type.Optional(Type.String()), projectionFormat: Type.Optional(Type.String()), conflictPolicy: Type.Optional(Type.String()), includeFieldProvenance: Type.Optional(Type.Boolean()), includeContentPreview: Type.Optional(Type.Boolean()), includeRaw: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryMoltMapCompose("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { neoblockIds: input.neoblockIds, manifestKind: input.manifestKind ?? 'neoblock', summaryProfile: input.summaryProfile ?? 'standard', projectionFormat: input.projectionFormat ?? 'both', conflictPolicy: input.conflictPolicy ?? 'report_only', includeFieldProvenance: input.includeFieldProvenance !== false, includeContentPreview: input.includeContentPreview !== false, includeRaw: Boolean(input.includeRaw) }), null, 2) }] }; } }, { optional: true });
        api.registerTool({ name: "umg_envoy_block_library_response_envelope_fragment", description: "Render a UMG-style response envelope fragment from an explicit normalized MOLT Map composition.", parameters: Type.Object({ neoblockIds: Type.Array(Type.String()), project: Type.Optional(Type.String()), currentState: Type.Optional(Type.String()), activeTool: Type.Optional(Type.String()), formalResponseContent: Type.Optional(Type.String()), envoyIntuition: Type.Optional(Type.String()), projectionFormat: Type.Optional(Type.String()), includeMetadata: Type.Optional(Type.Boolean()), includeAudit: Type.Optional(Type.Boolean()), activeSleeve: Type.Optional(Type.String()), activeStackBoundary: Type.Optional(Type.String()), includeActiveStackProjection: Type.Optional(Type.Boolean()), includeRaw: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryResponseEnvelopeFragment("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { neoblockIds: input.neoblockIds, project: input.project, currentState: input.currentState, activeTool: input.activeTool, formalResponseContent: input.formalResponseContent, envoyIntuition: input.envoyIntuition, projectionFormat: input.projectionFormat ?? 'both', includeMetadata: input.includeMetadata !== false, includeAudit: input.includeAudit !== false, activeSleeve: input.activeSleeve, activeStackBoundary: input.activeStackBoundary, includeActiveStackProjection: input.includeActiveStackProjection !== false, includeRaw: Boolean(input.includeRaw) }), null, 2) }] }; } }, { optional: true });
        api.registerTool({ name: "umg_envoy_block_library_active_stack_projection", description: "Render a normalized Active Stack projection from explicit runtime state and optional normalized composer context.", parameters: Type.Object({ project: Type.Optional(Type.String()), currentState: Type.Optional(Type.String()), activeTool: Type.Optional(Type.String()), sourceTool: Type.Optional(Type.String()), neoblockIds: Type.Optional(Type.Array(Type.String())), activeSleeve: Type.Optional(Type.String()), boundary: Type.Optional(Type.String()), projectionFormat: Type.Optional(Type.String()), includeAudit: Type.Optional(Type.Boolean()), includeRaw: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(getBlockLibraryActiveStackProjection("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { project: input.project, currentState: input.currentState, activeTool: input.activeTool, sourceTool: input.sourceTool, neoblockIds: input.neoblockIds ?? [], activeSleeve: input.activeSleeve, boundary: input.boundary, projectionFormat: input.projectionFormat ?? 'both', includeAudit: input.includeAudit !== false, includeRaw: Boolean(input.includeRaw) }), null, 2) }] }; } }, { optional: true });
        ...
        api.registerTool({ name: "umg_envoy_runtime_bounded_read_only_orchestrate", description: "Compose the proven Alpha7 inspector, preview, classification, gate, checkpoint, and tiny allowlisted read-only execution path into one bounded orchestration report.", parameters: Type.Object({ sleeveId: Type.Optional(Type.String()), requestedToolName: Type.Optional(Type.String()), requestedAction: Type.Optional(Type.String()), approvalDecision: Type.Optional(Type.String()), mode: Type.Optional(Type.String()), includeInspector: Type.Optional(Type.Boolean()), includeRuntimePreview: Type.Optional(Type.Boolean()), includeIrMatrix: Type.Optional(Type.Boolean()), includeEnvelope: Type.Optional(Type.Boolean()), includeExecutionGateState: Type.Optional(Type.Boolean()), includeTrace: Type.Optional(Type.Boolean()), root: Type.Optional(Type.String()) }, { additionalProperties: false }), async execute(input) { return { content: [{ type: "text", text: JSON.stringify(runBoundedReadOnlyOrchestration("0.3.0-alpha.8", "dist/plugin-entry.js", input.root ?? defaultBlockLibraryRoot(), { sleeveId: input.sleeveId, requestedToolName: input.requestedToolName, requestedAction: input.requestedAction, approvalDecision: input.approvalDecision, mode: input.mode, includeInspector: input.includeInspector !== false, includeRuntimePreview: input.includeRuntimePreview !== false, includeIrMatrix: input.includeIrMatrix !== false, includeEnvelope: input.includeEnvelope !== false, includeExecutionGateState: input.includeExecutionGateState !== false, includeTrace: input.includeTrace !== false }), null, 2) }] }; } }, { optional: true });
    }
};
