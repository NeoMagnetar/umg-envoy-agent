...
function deriveReadinessRow(input) {
    ...
    Object.entries(gates).forEach(([key, value]) => {
        ...
        if (['present', 'valid', 'satisfied', 'available'].includes(value))
...
export function projectControlledActionExecutionReadinessMatrix(input) {
...
function buildDefaultInputFromBlockedSummary() {
