export type RuntimeReportPanelId = "overview" | "active_route" | "safety_evidence_chain" | "blocked_capabilities" | "readiness" | "audit_and_review" | "recording_metadata" | "hard_boundaries" | "next_safe_step";
...
export interface RuntimeReportBlockedCapability {
    id: "execute_action" | "write_files" | "bridge_actions" | "direct_source" | "automatic_takeover" | "package_publish";
    label: string;
    status: "blocked" | "off";
    reason: string;
}
