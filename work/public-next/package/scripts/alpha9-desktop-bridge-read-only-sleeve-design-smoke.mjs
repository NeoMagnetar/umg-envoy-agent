...
const designPath = path.join(packageRoot, 'fixtures', 'native-sleeves', 'umg-desktop-bridge-observer-native-v1.design.json');
...
if (design.hardBoundaries.desktopActionsEnabled !== false) throw new Error('desktopActionsEnabled drift');
