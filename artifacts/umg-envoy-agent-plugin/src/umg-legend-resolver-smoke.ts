...
function makeValidDoc(): UMGPathDocument {
  return {
    use: "USE.001",
    aim: "AIM.001",
    need: ["NEED.001"],
...
function makeUnknownSleeveDoc(): UMGPathDocument {
  return {
    ...makeValidDoc(),
...
function makeMismatchDoc(): UMGPathDocument {
  return {
    ...makeValidDoc(),
    loadedStacks: ["S.99"],
    stacks: [
...
export function runLegendResolverSmoke(): Record<string, unknown> {
