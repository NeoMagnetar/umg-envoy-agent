param(
  [string]$StageRoot = "C:\.openclaw\workspace\umg-envoy-agent-publish-stage\umg-envoy-agent-0.2.8"
)
...
Copy-Item (Join-Path $repoRoot 'docs\RELEASE-NOTES-0.2.8.md') (Join-Path $StageRoot 'docs')
