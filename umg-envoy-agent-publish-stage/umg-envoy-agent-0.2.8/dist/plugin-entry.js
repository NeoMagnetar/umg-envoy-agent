...
const entry = {
    ...
    description: "UMG Envoy Agent is an OpenClaw code plugin for bundled-adapter public UMG workflows: loading bundled public sleeves, resolving artifacts, validating runtime outputs, and providing public-safe diagnostics and inspection surfaces.",
    register(api, config) {
